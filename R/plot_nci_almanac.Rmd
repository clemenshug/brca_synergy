...
growth_data_single_dose_all <- growth_data_all %>%
...
plt <- pmap(growth_data_bliss_nested[3000, ], plot_combo)[[1]]
...
plt <- pmap(growth_data_bliss_nested[162290, ], plot_combo)[[1]]
ggsave(
  file.path(dir_res, "nci_almanac_example_combo_doxo_doce_problematic.pdf"),
  plt, width = 8, height = 9
)

plt <- pmap(growth_data_bliss_nested[161295, ], plot_combo)[[1]]
ggsave(
...
plot_scatter_rasterly(
  ...
  x_range = c(1.2, -12.5), y_range = c(-2.5, 2.5),
...
plot_scatter_rasterly(
  ...
  x_range = c(1.5, -12.5), y_range = c(-2.5, 2.5),
