...
growth_data_bliss_agg <- growth_data_bliss_agg_nested %>%
  ...
  # transmute(
  #   data = map2(
  #     data, agg_name, ~rename_with(
  #       .x,
  #       .cols = c(starts_with("gr"), starts_with("excess_bliss"),
  #         starts_with("log_kills"), starts_with("fraction_killing")),
  #       .fn = paste, .y, sep = "_"
  #     ) %>%
  #   )
...
#     gr_mid = gr[drug_concentration_index_1 == 2 & drug_concentration_index_2 == 2],
#     excess_bliss_gr_mid = excess_bliss[drug_concentration_index_1 == 2 & drug_concentration_index_2 == 2],
#     excess_bliss_gr_min = mean(excess_bliss[gr == gr_min]),
#     excess_bliss_mean = mean(excess_bliss),
#     log_kills_max = max(log_kills, na.rm = TRUE),
#     excess_bliss_log_kills_max =  mean(excess_bliss[log_kills == log_kills_max]),
#     fraction_killing_gr_min = fraction_killing[gr == gr_min],
#     fraction_killing_1_gr_min = fraction_killing_1[gr == gr_min],
#     fraction_killing_2_gr_min = fraction_killing_1[gr == gr_min],
#     .groups = "drop"
#   )
...
#   growth_data_bliss, gr, excess_bliss, "nci_almanac_gr_vs_excess_bliss_scatter_2.pdf",
#   x_range = c(1.5, -3), y_range = c(-2, 2),
#   xlab = "GR", ylab = "Excess over Bliss"
# )

# x <- plot_scatter_rasterly_2(
#   growth_data_bliss_auc, gr_min, AUC, "nci_almanac_gr_min_vs_auc_scatter",
#   x_range = c(1.5, -2), y_range = c(-5, 5),
#   xlab = "GR min", ylab = "Excess over Bliss AUC"
# )
# 
# ggsave("test3.pdf", x, width = 12, height = 8)
